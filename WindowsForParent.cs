...
{
    public partial class WindowsForParent : Form
    {

        public WindowsForParent()
        {
            InitializeComponent();
        }

        private void WindowsForParent_Load(object sender, EventArgs e)
        {
            txtUrl.Show();
            // btnNewtab.Hide();
        ...
        {
            ParentHistory p = new ParentHistory();
            this.Hide();
            p.Show();
        }
        ...
        private void btnHistory_Click(object sender, EventArgs e)
        {
            ...
            ParentMonitorChild p = new ParentMonitorChild();
            this.Hide();
            p.Show();
